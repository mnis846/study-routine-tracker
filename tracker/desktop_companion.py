...
def _quick_log_hours(hours: float) -> None:
    ...
    try:
        from tracker.coach import get_coach, get_line, pick_coach_key
...
class StudySticker:
    def __init__(self):
        from tracker.coach import get_startup_brief
    ...
    def _on_right_click(self, _event):
        from tracker.coach import get_coach, get_line, next_coach_key
